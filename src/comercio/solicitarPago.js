        ...
        <BrowserView style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}  >
            ...
            >
                <div className={classes.container} style={{
                    ...
                    justifyContent: 'flex-start', alignItems: 'stretch', overflow: 'hidden',
                }}  >

                    <div style={{
                        marginBottom: '4px', borderLeft: `5px solid ${color.alcanceOrange}`, display: 'flex', flexDirection: 'column',
