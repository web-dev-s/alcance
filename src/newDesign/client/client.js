...
import classes from '../../containers/DashboardScreen/DashBoardScreen.css';
...
const UserTypeClient = props => {
    ...
    return (<div className={classes.container} style={{ display: 'inline', }}>
        ...
        <div className={classes.container} style={{ display: 'inline', position: 'relative', width: '100%', backgroundColor: 'orange',/*  minHeight: '500px', */ backgroundPosition: 'center' }}>
            <BrowserView>
                        ...
                        <Grid container item spacing={4} justify="flex-start" alignItems="flex-start">
                            ...
                            <Grid zeroMinWidth container item md={6} lg={4} spacing={1}   >
                                <Card title={'Comprar o pagar'} backgroundimage={paymentMethod}>
                                    <div style={{ display: 'flex', width: '100%' }} >
                                        <div style={{ display: 'column', justifyContent: 'center', alignItems: 'center', textAlign: 'center', width: '100%' }}>
                                            {/*  <Button color="primary"
                                                style={{ marginTop: '12px', color: 'white', backgroundColor: '#f8bb48', borderRadius: '5px', fontSize: ' bold', textAlign: ' center', display: 'inline-block', fontFamily: 'AvenirBlack' }}
                                                onClick={(e) => setGeneratedQR(<QRCode value={props.userId} />)}>
                                                GEN QR CÓDIGO
                    </Button> */}
                                            <div style={{ marginTop: '12px', marginBottom: '12px', fontSize: ' bold', textAlign: ' center', display: 'inline-block', fontFamily: 'AvenirBlack', width: '90%', height: '30%' }}                                            >
                                                <FlashingButton
                                                    clicked={(e) => setGeneratedQR(<QRCode value={props.userId} />)}
                                                    label={'GEN CÓDIGO QR'}
                                                    style={{ color: 'white', alignSelf: 'center', backgroundColor: '#f8bb48', borderRadius: '10px', minHeight: '40px', fontWeight: 'bold', textAlign: ' center', }} />
                                            </div>
                                            <div style={{ padding: '5px', paddingTop: '5%', paddingBottom: '15%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', textAlign: 'center' }}>
                                                {generatedQR}
                                                {generatedQR &&
                                                    <p style={{ fontFamily: 'AvenirRoman', textTransform: 'initial', marginLeft: '10px', marginRight: '5px', textAlign: 'center' }}>Preséntate con este código al comercio.</p>}
                            ...
                            <Grid zeroMinWidth container item md={6} lg={4} spacing={1}   >
                                <Card title={'Código remesas'} backgroundimage={password}>
                                    <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }} >
                                        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', alignSelf: 'center', textAlign: 'center' }}>
                                            {(rechargeCodeMessage !== null) && rechargeCodeMessage}
                                            <p style={{ fontFamily: 'AvenirRoman', textTransform: 'initial', marginLeft: '10px', marginRight: '5px', textAlign: 'center' }}>Introduzca el codigo de la remesa que recibiste:</p>
                            ...
                            <Grid zeroMinWidth container item md={6} lg={4} spacing={1}   >
                                <Card title={'Configuración y ayuda'} backgroundimage={customerSupport}>
                                    <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }} >
                                        <div style={{ marginTop: '12px', marginBottom: '12px', fontSize: ' bold', textAlign: ' center', display: 'inline-block', fontFamily: 'AvenirBlack', width: '70%', height: '60%' }}                                        >
                                            <FlashingButton
                                                clicked={(e) => {
                                                    props.onSetShowUserInfo(true);
                                                    props.history.push(props.match.userInfo);
                                        ...
                                        <div style={{ marginTop: '12px', marginBottom: '12px', fontSize: ' bold', textAlign: ' center', display: 'inline-block', fontFamily: 'AvenirBlack', width: '70%', height: '50%' }}                                        >
                                            <FlashingButton
                                                clicked={(e) => { alert('AYUDA') }}
                                                label={'AYUDA'}
                                                style={{ color: 'white', alignSelf: 'center', backgroundColor: '#f8bb48', borderRadius: '10px', minHeight: '40px', fontWeight: 'bold', textAlign: ' center', }} />
